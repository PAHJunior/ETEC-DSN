 ...
 * @author Casa
 */
public class pergunta04_quiz extends javax.swing.JFrame {

    /**
     * Creates new form pergunta04_quiz
     */
    public pergunta04_quiz() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "QUESTÃO 04", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(255, 255, 255))); // NOI18N
        ...
        jQuestao1.setText("<html>\"Cabeça\" está para \"Pé\" assim como \"Teto\" está para:</html>");
    ...
    private void jProximo1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jProximo1ActionPerformed
        // ABRIR O JFRAME DA PERGUNTA 5
        pergunta05_quiz frame = new pergunta05_quiz();
    ...
    private void jB_Questao3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jB_Questao3ActionPerformed
        correta = 'B';
        verificar ();
        String mensagem = "<html> <center> <p color = GREEN> RESPOSTA CORRETA !</p> </center>" +"<br/>"+"<p>Explicação: São os pontos opostos de cada objeto.</p></html>";
    ...
    private void jA_Questao3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jA_Questao3ActionPerformed
        ...
        jQuestaoB.setForeground(Color.GREEN); // QUESTÃO CORRETA
        jQuestaoC.setForeground(Color.RED); 
        jQuestaoD.setForeground(Color.RED);
        String mensagem = "<html> <center> <p color = RED> RESPOSTA ERRADA !</p> </center>" +"<br/>"+ "A resposta correta é : CHÃO"+"<br/>"+"Explicação: São os pontos opostos de cada objeto.</html>";
        JOptionPane.showMessageDialog(null, mensagem );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pergunta04_quiz.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new pergunta04_quiz().setVisible(true);
            }
        });
    }
