 ...
 * @author Casa
 */
public class pergunta03_quiz extends javax.swing.JFrame {

    /**
     * Creates new form pergunta03_quiz
     */
    public pergunta03_quiz() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "QUESTÃO 03", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(255, 255, 255))); // NOI18N
        ...
        jQuestao1.setText("<html>\"Amigo\" está para \"Inimigo\" assim como \"Alegria\" está para:</html>");
    ...
    private void jProximo1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jProximo1ActionPerformed
        ...
        pergunta04_quiz frame = new pergunta04_quiz();
    ...
    //SE FOR A QUESTAO ERRADA , FAÇA...
    private void jA_Questao3(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jA_Questao3
        verificar ();
        ...
        String mensagem = "<html> <center> <p color = RED> RESPOSTA ERRADA !</p> </center>" +"<br/>"+ "A resposta correta é : TRISTEZA"+"<br/>"+"<p>O antônimo de Alegria é Tristeza ..</p></html>";
        JOptionPane.showMessageDialog(null, mensagem );
    }//GEN-LAST:event_jA_Questao3

    private void jC_Questao3_CORRETA(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jC_Questao3_CORRETA
        correta = 'C';
        verificar ();
        String mensagem = "<html> <center> <p color = green> RESPOSTA CORRETA !</p></center>" + "<br/>" + "<p>O antônimo de Alegria é Tristeza ..</p></html>";
        JOptionPane.showMessageDialog(null, mensagem);
    }//GEN-LAST:event_jC_Questao3_CORRETA
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pergunta03_quiz.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new pergunta03_quiz().setVisible(true);
            }
        });
    }
